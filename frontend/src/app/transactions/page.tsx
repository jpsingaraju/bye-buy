...
const DUMMY_TRANSACTIONS: Transaction[] = [
  { id: 901, amount_cents: 42000, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 2).toISOString(), listing_id: 1, buyer_id: 1, conversation_id: 1, tracking_number: "1Z999AA10123456784", paid_at: new Date(Date.now() - 86400000 * 3).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 2.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 2).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 1.5).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 902, amount_cents: 120000, status: "shipped", created_at: new Date(Date.now() - 86400000 * 1).toISOString(), listing_id: 2, buyer_id: 2, conversation_id: 2, tracking_number: "9400111899223100001", paid_at: new Date(Date.now() - 86400000 * 1.5).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 0.5).toISOString(), delivered_at: null, paid_out_at: null, refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 903, amount_cents: 8500, status: "payment_held", created_at: new Date(Date.now() - 3600000 * 4).toISOString(), listing_id: 3, buyer_id: 3, conversation_id: 3, tracking_number: null, paid_at: new Date(Date.now() - 3600000 * 3).toISOString(), shipped_at: null, delivered_at: null, paid_out_at: null, refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 904, amount_cents: 35000, status: "delivered", created_at: new Date(Date.now() - 86400000 * 5).toISOString(), listing_id: 4, buyer_id: 4, conversation_id: 4, tracking_number: "1Z999AA10123456789", paid_at: new Date(Date.now() - 86400000 * 6).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 5.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 5).toISOString(), paid_out_at: null, refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 905, amount_cents: 22500, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 8).toISOString(), listing_id: 5, buyer_id: 5, conversation_id: 5, tracking_number: "1Z888BB20234567890", paid_at: new Date(Date.now() - 86400000 * 9).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 8.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 8).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 7).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 906, amount_cents: 67500, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 12).toISOString(), listing_id: 6, buyer_id: 6, conversation_id: 6, tracking_number: "9400222899334200002", paid_at: new Date(Date.now() - 86400000 * 13).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 12.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 12).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 11).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 907, amount_cents: 15000, status: "pending", created_at: new Date(Date.now() - 3600000).toISOString(), listing_id: 7, buyer_id: 7, conversation_id: 7, tracking_number: null, paid_at: null, shipped_at: null, delivered_at: null, paid_out_at: null, refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: "https://checkout.stripe.com/example", updated_at: new Date().toISOString() },
  { id: 908, amount_cents: 95000, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 15).toISOString(), listing_id: 8, buyer_id: 8, conversation_id: 8, tracking_number: "1Z777CC30345678901", paid_at: new Date(Date.now() - 86400000 * 16).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 15.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 15).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 14).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 909, amount_cents: 18000, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 18).toISOString(), listing_id: 9, buyer_id: 9, conversation_id: 9, tracking_number: "9400333899445300003", paid_at: new Date(Date.now() - 86400000 * 19).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 18.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 18).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 17).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 910, amount_cents: 54000, status: "paid_out", created_at: new Date(Date.now() - 86400000 * 22).toISOString(), listing_id: 10, buyer_id: 10, conversation_id: 10, tracking_number: "1Z666DD40456789012", paid_at: new Date(Date.now() - 86400000 * 23).toISOString(), shipped_at: new Date(Date.now() - 86400000 * 22.5).toISOString(), delivered_at: new Date(Date.now() - 86400000 * 22).toISOString(), paid_out_at: new Date(Date.now() - 86400000 * 21).toISOString(), refunded_at: null, stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
  { id: 911, amount_cents: 31000, status: "refunded", created_at: new Date(Date.now() - 86400000 * 10).toISOString(), listing_id: 11, buyer_id: 11, conversation_id: 11, tracking_number: null, paid_at: new Date(Date.now() - 86400000 * 11).toISOString(), shipped_at: null, delivered_at: null, paid_out_at: null, refunded_at: new Date(Date.now() - 86400000 * 9).toISOString(), stripe_checkout_session_id: null, stripe_payment_intent_id: null, stripe_transfer_id: null, checkout_url: null, updated_at: new Date().toISOString() },
];
...
export default function TransactionsPage() {
  ...
  const txns = transactions.length > 0 ? transactions : DUMMY_TRANSACTIONS;
